          ...
          {GOALS.map((g) => (
            <div key={g.id} className="relative group/item">
              ...
              >
                ...
                <div>
                  <div className="text-base md:text-lg font-black uppercase italic tracking-tighter text-slate-900 mb-0.5 peer-data-[state=checked]:text-primary transition-colors">{g.label}</div>
                  <div className="text-xs text-slate-500 font-bold leading-tight max-w-xl peer-data-[state=checked]:text-slate-700 transition-colors">{g.desc}</div>
                </div>
