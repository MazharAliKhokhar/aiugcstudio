  ...
  return (
    <footer className="bg-[#070708] border-t border-white/5 py-12 px-6 relative z-10 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        ...
        <div>
          <h4 className="font-black text-xs uppercase tracking-[0.2em] text-white/20 mb-6">Product</h4>
        ...
        <div>
          <h4 className="font-black text-xs uppercase tracking-[0.2em] text-white/20 mb-6">Support</h4>
          <ul className="space-y-3 text-sm font-bold text-white/50">
      ...
      <div className="max-w-6xl mx-auto border-t border-white/5 pt-8 text-center text-xs font-black uppercase tracking-widest text-white/20">
