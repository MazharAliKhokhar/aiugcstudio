...
export function Footer() {
  return (
    <footer className="bg-background border-t border-black/5 py-12 px-6 relative z-10 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        <div className="md:col-span-2 space-y-4">
          <Link href="/" className="flex items-center gap-2.5 group cursor-pointer">
            ...
            <span className="font-black text-lg tracking-tight uppercase italic text-foreground">ViralUGC</span>
          </Link>
          <p className="text-foreground/70 max-w-sm font-medium">
        ...
        <div>
          <h4 className="font-black text-xs uppercase tracking-[0.2em] text-foreground/40 mb-6">Product</h4>
        ...
        <div>
          <h4 className="font-black text-xs uppercase tracking-[0.2em] text-foreground/40 mb-6">Support</h4>
          <ul className="space-y-3 text-sm font-bold text-foreground/80">
      ...
      <div className="max-w-6xl mx-auto border-t border-black/5 pt-8 text-center text-xs font-black uppercase tracking-widest text-foreground/30">
