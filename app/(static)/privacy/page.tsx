  ...
  return (
    <div className="max-w-3xl mx-auto py-24 px-6 space-y-8">
      ...
      <div className="prose prose-invert prose-emerald max-w-none">
        ...
        <p>We use reasonable organizational and technical security measures to protect your data. Your videos and payment details are handled by robust encrypted third parties (Supabase, Lemon Squeezy, and fal.ai).</p>
